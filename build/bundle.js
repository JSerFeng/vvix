...
var vvix = (function (exports) {
  ...
  const data = [
      {
          ...
          content: "The best TV Series EVER! Though it's a little bit " +
              " slow tempo at first. You mustn't miss it.",
      },
      {
          id: 1,
          title: "Breaking Bad",
          content: "The second best series, it's the best until I meet 《Better Call Saul》",
      },
      {
          id: 2,
  ...
  const Msg = ({ title, content }) => () => (jsxs("div", Object.assign({ class: "msg" }, { children: [jsx("h1", { children: title }, void 0),
          jsx("p", { children: content }, void 0)] }), void 0));
  const App = () => {
      const info = ref(data);
      return () => (jsxs(Fragment, { children: [jsx("h1", Object.assign({ class: "title" }, { children: "vvix" }), void 0),
              jsxs("div", { children: ["vvix", info.value.map((msg) => (jsx(Msg, { title: msg.title, content: msg.content }, msg.id)))] }, void 0)] }, void 0));
  };
  createApp(jsx(App, {}, void 0)).mount("#root");
