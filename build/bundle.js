...
var vvix = (function (exports) {
  ...
  const Msg = ({ title, content }) => {
      return () => (jsxs("div", { children: [jsx("h1", { children: title }, void 0),
  ...
  const App = () => {
      const info = ref([
          ...
          },
          {
              ...
              content: 'A little bit, how to say, "slow", but the first ' +
                  "several seasons are really great",
          },
      ]);
      return () => (jsx("div", { children: info.value.map((c) => (jsx(Msg, { title: c.title, content: c.content }, 1))) }, void 0));
  };
